...
public class UserController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("UserController: Recieved GET request");
		...
		if(app == null){
			System.out.println("UserController: App not found!");
			return;
		}
		
		// Begin auth procedures
		if(username != null && !username.isEmpty() && password != null && !password.isEmpty()){
			System.out.println("UserController: Trying to login user: " + username);

			if (app.signIn(username, password)){				
				System.out.println("UserController: Login success for user: " + username);
